...
app.post('/createShipment', (req, res) => {
    ...
    createShipment.execute(req.body.buyerCRN, req.body.drugName, req.body.listOfAssets, req.body.transporterCRN, req.body.organisationRole).then ((shipment) => {
        ...
        const result = {
            status: 'success',
            message: 'Shipment added successfully by ' + organisationRole,
            shipment: shipment
        };
        res.json(result);
    })
...
app.post('/updateShipment', (req, res) => {
    ...
    updateShipment.execute(req.body.buyerCRN, req.body.drugName, req.body.transporterCRN, req.body.organisationRole).then ((drugStatus) => {
...
app.post('/retailDrug', (req, res) => {
    console.log("Update Shipment for PO - Start");
    retailDrug.execute(req.body.drugName, req.body.serialNo, req.body.retailerCRN, req.body.customerAadhar, req.body.organisationRole).then ((drugStatus) => {
